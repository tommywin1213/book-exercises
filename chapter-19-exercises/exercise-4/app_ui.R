...
# This layout will contain the following elements:
  ...
  # the US."
  p("The image below diagram was created by the New York TImes to illustrate the increasing level of inequality in the US"),
...
growth_panel <- tabPanel(
  ...
  titlePane("Income growth 1980-2014"),
